    ...
    return (
        <div className="onboard-screen">
            <div className="onboard-card animate-in">
                ...
                <div style={{ fontSize: 12, color: 'var(--teal)', textAlign: 'center', lineHeight: 1.7 }}>
                    Disclaimer: Use this website and generated assignments at your own risk.
                    If your teacher or institution does not approve the assignment generated by this platform,
                    or if any academic issues, penalties, or other consequences occur, the creators of this website
                    and Team MH will not be responsible or liable in any way.
                </div>
